...
layout: default
title: "게시글·댓글 삭제 사용법"
description: "Android, Windows, macOS용 디시클리너의 로그인, 갤러리 선택, 게시글·댓글 삭제, 캡챠 해결 방법을 안내합니다."
permalink: /cleaner.html
---

# 디시클리너 사용법

디시클리너(디시 클리너)는 Android, Windows, macOS에서 사용할 수 있는 디시인사이드 게시글·댓글 삭제 프로그램입니다.
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/87809359-858a-40b9-92fa-ac29fd758c52" alt="디시클리너 게시글 및 댓글 삭제 시작 화면" width="360">
</p>

삭제 타입을 선택한 뒤 삭제할 갤러리를 선택합니다.

설정이 끝났다면 **삭제 시작** 버튼을 누르고 한 번 더 확인하면 삭제가 시작됩니다.

### 백그라운드 삭제

<p align="center">
  <img src="https://github.com/user-attachments/assets/4d4426fe-be5d-44a6-b745-c9156c6bfd54" alt="디시클리너 Android 백그라운드 삭제 화면" width="360">
</p>
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/d9d1d84d-77e1-4c1e-8da6-6eeea22917a5" alt="디시클리너 캡챠 해결 안내 화면" width="360">
</p>

삭제를 진행하다 보면 캡챠가 나타날 수 있습니다.

이 경우

1. **갤로그 열기**를 누릅니다.
2. PC 버전 갤로그에서 게시글 또는 댓글 하나를 직접 삭제합니다.
3. 앱으로 돌아와 **캡챠 해결 완료**를 누르면 다시 진행됩니다.
